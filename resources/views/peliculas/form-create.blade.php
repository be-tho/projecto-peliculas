...
@section('content')
    <main class="container formCreate" style="background:#fbfbfb;">
        <div class="row formCreate__cont">
            <div class="col-12 formCreate__cont-h1 text-center">
                ...
                <form action="{{ route('peliculas.create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="mb-3">
                        ...
                        @foreach( $generos as $genero)
                            <label class="form-check-label mr-2 generos__label">
                                <input type="checkbox" name="genero_id[]" value="{{ $genero->genero_id }}">
                                {{ $genero->nombre }}
                            </label>
                        @endforeach
                    </fieldset>
